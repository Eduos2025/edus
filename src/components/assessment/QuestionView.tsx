        ...
        >
          {question.options.map((option, idx) => (
            ...
            >
              ...
              <label htmlFor={`option-${idx}`} className="text-base font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70 flex-grow cursor-pointer">
                {option}
              </label>
            </motion.div>
          ))}
