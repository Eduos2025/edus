...
interface AssessmentCardProps {
  ...
  onStartAssessment: (assignment: Assignment) => void;
}

const AssessmentCard: React.FC<AssessmentCardProps> = ({ assignment, onStartAssessment }) => {
        ...
        <div className="space-y-2 flex-1">
          ...
          <div className="flex flex-wrap gap-4 mt-2 text-sm text-gray-500">
            <div className="flex items-center gap-1">
              ...
              <span>{assignment.timeToSpend}</span>
            </div>
            <div className="flex items-center gap-1">
            ...
            <div className="flex items-center gap-1">
              ...
              <span>Marks: {assignment.markContained}</span>
            </div>
          </div>
        </div>
