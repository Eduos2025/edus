...
const PendingSalaries = () => {
  ...
  const [selectedStaff, setSelectedStaff] = useState<null | { id: number, name: string, amount: number }>(null);
  ...
  const openApproveDialog = (staff: { id: number, name: string, amount: number }) => {
