...
import { Upload, ChevronLeft, Download, FileText, Plus } from 'lucide-react';
...
const UploadClassResult: React.FC = () => {
  ...
  const onSubmitClassSelection = (values: z.infer<typeof formSchema>) => {
