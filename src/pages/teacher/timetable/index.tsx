...
const timetableData: TimeTableEvent[] = [
  {
    id: '1',
    day: "Monday",
    startTime: '08:00',
...
const TeacherTimetable = () => {
  ...
  const openEditDialog = (event: TimeTableEvent) => {
    setSelectedEvent(event);
    setIsEditDialogOpen(true);
  };

  const openDeleteDialog = (event: TimeTableEvent) => {
    setSelectedEvent(event);
  ...
  return (
    <div className="space-y-6">
      ...
      <Tabs defaultValue="Monday" value={activeTab} onValueChange={(value) => setActiveTab(value as Day)}>
        ...
        {(["Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"] as Day[]).map(
          (day) => (
