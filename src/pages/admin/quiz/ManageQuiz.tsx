...
import { CheckCircle, Eye, FileText, Star, XCircle } from 'lucide-react';
...
const ManageQuiz = () => {
  ...
  const handleStatusChange = (quizId: number, newStatus: string) => {
  ...
  const getQuizPerformance = (quizId: number) => {
