...
import { Book, CheckCircle, Download, Eye, FileText, MessageSquare, ThumbsDown, ThumbsUp, Users } from 'lucide-react';
...
const ViewLessonPlans = () => {
  ...
  const getLessonPlanFeedback = (lessonPlanId: number) => {
