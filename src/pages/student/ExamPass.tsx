      ...
      <Card className="p-3 sm:p-6 mx-auto border-2 border-gray-200 shadow-lg print:shadow-none max-w-full sm:max-w-2xl">
        ...
        <CardContent className="space-y-4 p-0 sm:p-2">
          <div className="flex flex-col sm:flex-row sm:justify-between border-b pb-1">
            <span className="font-semibold text-center sm:text-left">Student Name:</span>
            <span className="text-center sm:text-right">{examPassData.studentName}</span>
          </div>
          <div className="flex flex-col sm:flex-row sm:justify-between border-b pb-1">
            <span className="font-semibold text-center sm:text-left">Admission Number:</span>
            <span className="text-center sm:text-right">{examPassData.admissionNumber}</span>
          </div>
          <div className="flex flex-col sm:flex-row sm:justify-between border-b pb-1">
            <span className="font-semibold text-center sm:text-left">Class:</span>
            <span className="text-center sm:text-right">{examPassData.class}</span>
          </div>
          <div className="flex flex-col sm:flex-row sm:justify-between border-b pb-1">
            <span className="font-semibold text-center sm:text-left">Term:</span>
            <span className="text-center sm:text-right">{examPassData.term}</span>
          </div>
          <div className="flex flex-col sm:flex-row sm:justify-between border-b pb-1">
            <span className="font-semibold text-center sm:text-left">Session:</span>
            <span className="text-center sm:text-right">{examPassData.session}</span>
          </div>
        </CardContent>
        
        <div className="mt-6 p-3 sm:p-4 bg-gray-50 border border-gray-300 rounded-md">
          <p className="text-center font-medium text-sm sm:text-base">This pass grants access to examination halls for the {examPassData.term} examinations.</p>
          <p className="text-center text-xs sm:text-sm text-gray-500 mt-2">Present this pass to the invigilator before entering the examination hall.</p>
        </div>
