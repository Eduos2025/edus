...
const StudentDashboard: React.FC = () => {
  ...
  // Add links to other features for easy navigation
  const quickLinks = [
    {
  ...
  return (
    ...
    >
      ...
      {/* Quick Access Cards */}
      <div>
        <h2 className="text-lg sm:text-xl md:text-2xl font-bold mb-3 sm:mb-4 text-gray-800 text-center sm:text-left">Quick Access</h2>
